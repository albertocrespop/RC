...
public class PeerMessageOps {
	...
	public static final byte OPCODE_TRANSFER_FILE = 2;
	public static final byte OPCODE_DOWNLOAD_REQUEST = 3;
	public static final byte OPCODE_SEND_HASH = 4;
	public static final byte OPCODE_HASH_RECEIVED = 5;
	...
	private static final Byte[] _valid_opcodes = {
			...
			OPCODE_TRANSFER_FILE,
			OPCODE_DOWNLOAD_REQUEST,
			OPCODE_SEND_HASH,
			OPCODE_HASH_RECEIVED
